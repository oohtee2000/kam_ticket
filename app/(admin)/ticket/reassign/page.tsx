...
// Mocked authentication hook — replace with your real one!
...
const ReassignTicket = () => {
    const { user } = useAuth(); // Assume it provides user object with { role }
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
                <div className="bg-white p-8 rounded shadow-md text-center">
                    <h2 className="text-2xl font-semibold text-red-600 mb-4">You don't have access to reassign tickets.</h2>
                    <Button 
                        type="primary" 
    ...
    return (
        // <div className="min-h-screen w-full p-8 bg-gray-100 flex flex-col items-center justify-center">
        //     <div className="max-w-4xl w-full p-6 bg-white shadow-lg rounded-lg border border-gray-200">
        //         <h1 className="text-3xl font-bold text-gray-900 mb-8">Reassign Ticket</h1>
        ...
        //                 {selectedUserDetails && (
        //                     <div className="mb-6">
        //                         <h2 className="text-xl font-semibold text-gray-800">New Assignee Details</h2>
        //                         <Descriptions bordered>
        ...
        //                         type="primary"
        //                         block
        //                         className="bg-green-600 hover:bg-green-700 text-white font-semibold text-lg py-3"
        //                         onClick={() =>
        //                             handleReassignUser({
        //                                 selectedTicket,
        //                                 selectedUser,
